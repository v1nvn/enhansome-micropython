...
* [emlearn-micropython](https://github.com/emlearn/emlearn-micropython) ⭐ 155 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-04-01 - Efficient Machine Learning engine for MicroPython.
* [upython-chat-gpt](https://github.com/karlsoderby/upython-chat-gpt) ⭐ 30 | 🐛 1 | 🌐 Python | 📅 2023-06-05 - ChatGPT for MicroPython.
* [mp\_esp\_dl\_models](https://github.com/cnadler86/mp_esp_dl_models) ⭐ 11 | 🐛 2 | 🌐 C++ | 📅 2025-09-10 - MicroPython binding for the ESP DL vision models like face detection.
* [MicroPython-NeuralNetwork](https://gitlab.com/olivierlenoir/MicroPython-NeuralNetwork) - Neural Network for MicroPython.

### Audio

* [micropython-i2s-examples](https://github.com/miketeachman/micropython-i2s-examples) ⭐ 302 | 🐛 14 | 🌐 Python | 📅 2025-01-26 - Examples for I2S support on microcontrollers that run MicroPython.
...
* [micropython-dfplayer](https://github.com/redoxcode/micropython-dfplayer) ⭐ 23 | 🐛 1 | 🌐 Python | 📅 2025-11-16 - Library to control the DFPlayer mini MP3 player module.
...
* [yx5300](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/yx5300.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MP3 player that can be controlled via a serial interface.
* [IoTy vs1003](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/vs1003.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - Driver for the VS1003 MP3 decoder / encoder. Supports playing of MP3, WMA, MIDI, ADPCM, and recording of ADPCM.
...
* [multi-midi](https://github.com/HLammers/multi-midi) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2025-08-24 - Library for RP2 boards, providing an interface for UART and PIO based hardware MIDI and USB MIDI 1.0.
...
* [micropython-telegram-bot](https://github.com/antirez/micropython-telegram-bot) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2024-10-19 - MicroPython telegram bot library: simple way to put your IoT projects on the cloud.
...
* [MicroPythonBLEHID](https://github.com/Heerkog/MicroPythonBLEHID) ⭐ 321 | 🐛 1 | 🌐 Python | 📅 2026-01-17 - Human Interface Device (HID) over Bluetooth Low Energy (BLE) GATT library for MicroPython.
...
* [BTHome-MicroPython](https://github.com/DavesCodeMusings/BTHome-MicroPython) ⭐ 17 | 🐛 6 | 🌐 Python | 📅 2025-11-09 - MicroPython module to format sensor readings for BTHome BLE advertising payloads.
...
* [micropython\_aioble\_examples](https://github.com/ekspla/micropython_aioble_examples) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-04-01 - A few aioble (asyncio BLE) examples of MicroPython using ESP32.
...
* [tamp](https://github.com/BrianPugh/tamp) ⭐ 65 | 🐛 2 | 🌐 C | 📅 2026-04-13 - A low-memory, MicroPython-optimized, DEFLATE-inspired lossless compression library.
...
* [micropython-zipfile](https://github.com/jonnor/micropython-zipfile) ⭐ 18 | 🐛 2 | 🌐 Python | 📅 2024-11-04 - Read/write ZIP archive files. Ported from CPython, supports DEFLATE compression.
* [bitstruct-micropython](https://github.com/peterzuger/bitstruct-micropython) ⭐ 7 | 🐛 2 | 🌐 C | 📅 2024-03-22 - MicroPython port of [bitstruct](https://github.com/eerimoq/bitstruct) ⭐ 134 | 🐛 14 | 🌐 C | 📅 2026-02-17.

#### Cryptography

* [embit](https://github.com/diybitcoinhardware/embit) ⭐ 109 | 🐛 40 | 🌐 Python | 📅 2026-03-18 - A minimal Bitcoin library for MicroPython and Python 3 with a focus on embedded systems.
...
* [aiodns](https://github.com/vshymanskyy/aiodns) ⭐ 26 | 🐛 5 | 🌐 Python | 📅 2025-01-08 - A small, versatile DNS client that provides an async version of `getaddrinfo` and works with any connectivity.
...
* [FTP-Server-for-ESP8266-ESP32-and-PYBD](https://github.com/robert-hh/FTP-Server-for-ESP8266-ESP32-and-PYBD) ⭐ 162 | 🐛 0 | 🌐 Python | 📅 2025-05-22 - Small FTP server for ESP8266/ESP32/Pyboard on the MicroPython platform.
...
* [Asynchronous GPS driver](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/GPS.md) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - Receive and parse GPS data as a uasyncio task.
* [micropyGPS](https://github.com/inmcm/micropyGPS) ⭐ 386 | 🐛 15 | 🌐 Python | 📅 2023-02-18 - Full featured GPS NMEA sentence parser.
...
* [micropython-upyphone](https://github.com/jeffmer/micropython-upyphone) ⭐ 427 | 🐛 0 | 🌐 Python | 📅 2017-11-24 - A GSM phone using Pyboard and SIM800l.
* [sim800](https://github.com/basanovase/sim800) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2025-12-08 - Library for interfacing with SIM800 module in MicroPython.
...
* [mrequests](https://github.com/SpotlightKid/mrequests) ⭐ 63 | 🐛 0 | 🌐 Python | 📅 2024-06-20 - A HTTP client module (not only) for MicroPython with an API similar to requests.
...
* [micropython-ha-mqtt-device](https://github.com/agners/micropython-ha-mqtt-device) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2020-05-08 - MicroPython module which allows creating Entites for HomeAssistant using MQTT Discovery.
...
* [sensor-mqtt-homeassistant](https://github.com/DougWilkinson/sensor-mqtt-homeassistant) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2022-07-01 - An ESP8266/ESP32 MicroPython-based sensor platform for GPIO, DHT, analog, LED and more. Includes remote updates for .py code from web server and MQTT/Home Assistant integration.
...
* [micropython\_ir](https://github.com/peterhinch/micropython_ir) ⭐ 303 | 🐛 13 | 🌐 Python | 📅 2025-08-13 - Nonblocking device drivers to receive from IR remotes and for IR "blaster" apps.
* [esp8266\_ir](https://github.com/ruoyu0088/esp8266_ir) ⭐ 51 | 🐛 3 | 🌐 Python | 📅 2017-10-16 - Control IR signal by WebSocket.
* [micropython-ys-irtm](https://github.com/mcauser/micropython-ys-irtm) ⭐ 34 | 🐛 0 | 📅 2019-12-20 - MicroPython examples for YS-IRTM 5V NEC Infrared UART transceivers.
...
* [micropySX126X](https://github.com/ehong-tl/micropySX126X) ⭐ 159 | 🐛 14 | 🌐 Python | 📅 2025-12-07 - Semtech SX126X LoRa driver for MicroPython and CircuitPython.
...
* [u-lora](https://github.com/martynwheeler/u-lora) ⭐ 91 | 🐛 15 | 🌐 Python | 📅 2023-10-05 - Raspi-lora for MicroPython.
...
* [micropython-mqtt](https://github.com/peterhinch/micropython-mqtt) ⭐ 679 | 🐛 21 | 🌐 Python | 📅 2026-03-14 - A 'resilient' asynchronous MQTT client: recovers from WiFi and broker outages.
* [MQBoard](https://github.com/tve/mqboard) ⭐ 127 | 🐛 20 | 🌐 Python | 📅 2022-05-08 - A micro-framework for using MQTT with asyncio on MicroPython boards, primarily on the ESP32.
* [pysmartnode](https://github.com/kevinkk525/pysmartnode) ⭐ 118 | 🐛 2 | 🌐 Python | 📅 2021-05-31 -  MicroPython Smart Home framework.
...
* [NFC\_PN532\_SPI](https://github.com/Carglglz/NFC_PN532_SPI) ⭐ 47 | 🐛 5 | 🌐 Python | 📅 2023-07-17 - Partial port of Adafruit CircuitPython to MicroPython of PN532 NFC/RFID control library (SPI).
* [micropython-nfc](https://github.com/rolandvs/micropython-nfc) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-01-12 - Using NFC with MicroPython.
...
* [Official OneWire](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/bus/onewire) ⭐ 2,783 | 🐛 293 | 🌐 Python | 📅 2026-04-15 - For devices using the OneWire bus, eg Dallas DS18x20.
...
* [micropython-ota-updater](https://github.com/rdehuyss/micropython-ota-updater) ⭐ 378 | 🐛 9 | 🌐 Python | 📅 2022-03-09 - OTA Updater for MicroPython.
...
* [Official nRF24L01](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/radio/nrf24l01) ⭐ 2,783 | 🐛 293 | 🌐 Python | 📅 2026-04-15 - Official driver for nRF24L01 2.4GHz radio modules.
* [micropython\_remote](https://github.com/peterhinch/micropython_remote) ⭐ 81 | 🐛 2 | 🌐 Python | 📅 2021-12-17 - Capture and replay 433MHz remote control codes. Control remote switched power adaptors.
...
* [micropython-mfrc522](https://github.com/wendlers/micropython-mfrc522) ⭐ 187 | 🐛 21 | 🌐 Python | 📅 2024-01-18 - Driver for NXP MFRC522 RFID reader/writer.
...
* [micropython-ds1302-rtc](https://github.com/omarbenhamid/micropython-ds1302-rtc) ⭐ 54 | 🐛 2 | 🌐 Python | 📅 2021-07-12 - DS1302 RTC Clock driver for MicroPython.
* [micropython-DS3231-AT24C32](https://github.com/pangopi/micropython-DS3231-AT24C32) ⭐ 35 | 🐛 2 | 🌐 Python | 📅 2024-07-25 - MicroPython driver for DS3231 RTC.
...
* [I2C Slave](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/I2C.md) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - Uses the Pyboard's I2C slave mode to implement a full duplex asynchronous link. Principal use case is for ESP8266 which has only one UART.
...
* [microSDI12](https://github.com/insighio/microSDI12) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-04-02 - A mini SDI-12 implementation for getting sensor info over RS-485.
...
* [micropython-msgpack](https://github.com/peterhinch/micropython-msgpack) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2025-06-30 - MessagePack serialisation library optimised for MicroPython.
...
* [microdot](https://github.com/miguelgrinberg/microdot) ⭐ 2,107 | 🐛 9 | 🌐 Python | 📅 2026-03-26 - The impossibly small web framework for MicroPython.
* [MicroWebSrv2](https://github.com/jczic/MicroWebSrv2) ⭐ 716 | 🐛 55 | 🌐 Python | 📅 2025-08-18 - The last micro web server for IoTs (MicroPython) or large servers (CPython), that supports WebSocket, routes, template engine and with really optimized architecture (mem allocations, async I/Os).
* [MicroWebSrv](https://github.com/jczic/MicroWebSrv) ⭐ 663 | 🐛 13 | 🌐 Python | 📅 2023-01-17 - A micro HTTP web server that supports WebSockets, HTML/Python language templating and routing handlers, for MicroPython (used on Pycom modules & ESP32).
* [tinyweb](https://github.com/belyalov/tinyweb) ⭐ 278 | 🐛 20 | 🌐 Python | 📅 2024-05-14 - Simple and lightweight HTTP async server for MicroPython.
* [uwebsockets](https://github.com/danni/uwebsockets) ⭐ 216 | 🐛 15 | 🌐 Python | 📅 2023-06-09 - MicroPython WebSocket implementation for ESP8266.
* [micropyserver](https://github.com/troublegum/micropyserver) ⭐ 158 | 🐛 3 | 🌐 Python | 📅 2025-01-12 - MicroPyServer is a simple HTTP server for MicroPython projects.
* [micropython-nanoweb](https://github.com/hugokernel/micropython-nanoweb) ⭐ 120 | 🐛 1 | 🌐 Python | 📅 2025-11-14 - Full async MicroPython web server with small memory footprint.
...
* [microCoAPy](https://github.com/insighio/microCoAPy) ⭐ 70 | 🐛 5 | 🌐 Python | 📅 2025-06-20 - A mini client/server implementation of CoAP (Constrained Application Protocol) into MicroPython.
...
* [micropidash](https://github.com/kritishmohapatra/micropidash) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2026-03-20 – Simple web dashboard served directly from MicroPython boards (ESP32, Pico W).
...
* [WiFiManager](https://github.com/tayfunulu/WiFiManager) ⭐ 412 | 🐛 28 | 🌐 Python | 📅 2025-08-08 - WiFi manager for ESP8266 - ESP12 - ESP32 - MicroPython.
* [micropython-wifimanager](https://github.com/mitchins/micropython-wifimanager) ⭐ 70 | 🐛 0 | 🌐 Python | 📅 2025-07-23 - A simple network configuration utility for MicroPython on the ESP8266 board.
...
* [enigmapython](https://github.com/denismaggior8/micropython-enigma-python) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-03-31 - A simple yet faithful library to emulate different Enigma machines models using MicroPython.

### Display

#### E-Paper

* [micropython-waveshare-epaper](https://github.com/mcauser/micropython-waveshare-epaper) ⭐ 389 | 🐛 22 | 🌐 Python | 📅 2021-09-01 - Drivers for various Waveshare ePaper modules.
* [uc8151\_micropython](https://github.com/antirez/uc8151_micropython) ⭐ 164 | 🐛 4 | 🌐 Python | 📅 2024-04-05 - UC8151 / IL0373 MicroPython e-paper display driver with support for greyscales and fast updates.
* [Inkplate-micropython](https://github.com/SolderedElectronics/Inkplate-micropython) ⭐ 91 | 🐛 5 | 🌐 Python | 📅 2026-03-16 - MicroPython driver for Inkplate boards.
* [micropython-waveshare-epd](https://github.com/ayoy/micropython-waveshare-epd) ⭐ 58 | 🐛 3 | 🌐 Python | 📅 2018-04-03 - Waveshare ePaper Display driver for devices running Pycom-flavored MicroPython.
* [uPyEINK](https://github.com/lemariva/uPyEINK) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2020-02-23 - Control a Waveshare 7.5" E-INK display using an ESP32 running MicroPython.
...
* [MicroPython-2.9-inch-ePaper-Library](https://github.com/rdagger/MicroPython-2.9-inch-ePaper-Library) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2025-05-22 - MicroPython Display Driver for WaveShare 2.9inch e-Paper Display (B).
...
* [micropython-font-to-py](https://github.com/peterhinch/micropython-font-to-py) ⭐ 459 | 🐛 8 | 🌐 Python | 📅 2025-05-28 - A Python 3 utility to convert fonts to Python source capable of being frozen as bytecode.
* [writer](https://github.com/peterhinch/micropython-font-to-py/blob/master/writer/WRITER.md) ⭐ 459 | 🐛 8 | 🌐 Python | 📅 2025-05-28 - A simple way to render above Python fonts to displays whose driver is subclassed from `framebuf`.
* [microfont](https://github.com/antirez/microfont) ⭐ 72 | 🐛 3 | 🌐 Python | 📅 2026-01-31 - Text drawing library for MicroPython framebuffer.
* [packed-font](https://github.com/mark-gladding/packed-font) ⭐ 32 | 🐛 1 | 🌐 Python | 📅 2023-06-05 -  Memory efficient MicroPython fonts for the Pico Pi and SSD1306 OLED Display.
...
* [framebuf2](https://github.com/peter-l5/framebuf2) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2023-05-30 - MicroPython FrameBuffer extension: larger and rotated font, triangles and circles.
...
* [mp\_jpeg](https://github.com/cnadler86/mp_jpeg) ⭐ 10 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A very fast MicroPython JPEG encoder and decoder for the ESP32.
* [MicroPython\_UPLOT](https://github.com/jposada202020/MicroPython_UPLOT) ⚠️ Archived - MicroPython Small Graphics Framework.

#### GUI

* [micropython-nano-gui](https://github.com/peterhinch/micropython-nano-gui) ⭐ 643 | 🐛 3 | 🌐 Python | 📅 2026-03-26 - A tiny display-only GUI with a limited set of GUI objects (widgets) for displays whose display driver is subclassed from the `framebuf` class. With drivers for TFT, ePaper and OLED displays.
* [lvgl](https://github.com/lvgl/lv_binding_micropython) ⭐ 343 | 🐛 67 | 🌐 C | 📅 2025-09-17 - An object-oriented, component-based high-level GUI library with MicroPython binding.
* [micro-gui](https://github.com/peterhinch/micropython-micro-gui) ⭐ 340 | 🐛 12 | 🌐 Python | 📅 2026-01-19 - Derived from nano-gui and supporting the same displays and hosts, this provides for user input via push buttons or a navigation joystick and an optional rotary encoder.
* [TFT-GUI](https://github.com/peterhinch/micropython-tft-gui) ⭐ 98 | 🐛 2 | 🌐 Python | 📅 2020-06-16 - A fast touch GUI for large displays based on SSD1963 controller with XPT2046 touch controller.
* [micropython-core2](https://github.com/lemariva/micropython-core2) ⭐ 63 | 🐛 4 | 🌐 C | 📅 2022-03-29 - Extends LV-MicroPython for the M5Stack CORE2 with MPU6886, ILI9342C, BM8563 and AXP192 drivers.
* [micropython-touch](https://github.com/peterhinch/micropython-touch) ⭐ 60 | 🐛 7 | 🌐 Python | 📅 2026-04-06 - Derived from nano-gui and supporting the same displays and hosts, this offers touch input. Supports various touch controllers.
...
* [Official LCD160CR](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/lcd160cr) ⭐ 2,783 | 🐛 293 | 🌐 Python | 📅 2026-04-15 - Driver for official MicroPython LCD160CR display with resistive touch sensor.
...
* [st7789\_mpy](https://github.com/russhughes/st7789_mpy) ⭐ 702 | 🐛 37 | 🌐 Python | 📅 2026-04-15 - Fast MicroPython driver for ST7789 display module written in C.
* [micropython-ili9341](https://github.com/rdagger/micropython-ili9341) ⭐ 294 | 🐛 3 | 🌐 Python | 📅 2025-03-02 - MicroPython ILI9341 display & XPT2046 touch screen driver.
* [MicroPython-ST7735](https://github.com/boochow/MicroPython-ST7735) ⭐ 269 | 🐛 10 | 🌐 Python | 📅 2022-12-30 - ESP32 version of GuyCarvers's ST7735 TFT LCD driver.
* [st7789py\_mpy](https://github.com/russhughes/st7789py_mpy) ⭐ 240 | 🐛 16 | 🌐 Python | 📅 2024-08-05 - Driver for 320x240, 240x240 and 135x240 ST7789 displays written in MicroPython.
* [st7789\_mpy](https://github.com/devbis/st7789_mpy) ⭐ 227 | 🐛 10 | 🌐 C | 📅 2024-01-23 - Fast pure-C driver for MicroPython that can handle display modules on ST7789 chip.
* [gc9a01\_mpy](https://github.com/russhughes/gc9a01_mpy) ⭐ 202 | 🐛 24 | 🌐 Python | 📅 2025-03-24 - Fast MicroPython driver for GC9A01 display modules written in C.
...
* [s3lcd](https://github.com/russhughes/s3lcd) ⭐ 109 | 🐛 10 | 🌐 Python | 📅 2024-03-20 - ESP\_LCD based MicroPython driver for ESP32-S3 Devices with ST7789 or compatible displays.
...
* [gc9a01py](https://github.com/russhughes/gc9a01py) ⭐ 59 | 🐛 7 | 🌐 Python | 📅 2021-05-06 - GC9A01 Display driver in MicroPython.
* [ili9342c\_mpy](https://github.com/russhughes/ili9342c_mpy) ⭐ 58 | 🐛 3 | 🌐 Python | 📅 2024-03-20 - ILI9342C Fast 'C' Driver for MicroPython (M5Stack Core).
* [ST77xx-pure-MP](https://github.com/antirez/ST77xx-pure-MP) ⭐ 51 | 🐛 4 | 🌐 Python | 📅 2025-03-25 - Pure MicroPython driver for ST77xx displays. Low memory requirements.
...
* [micropython-max7219](https://github.com/mcauser/micropython-max7219) ⭐ 207 | 🐛 8 | 🌐 Python | 📅 2019-07-03 - Driver for MAX7219 8x8 LED matrix modules.
...
* [micropython-tm1637](https://github.com/mcauser/micropython-tm1637) ⭐ 227 | 🐛 5 | 🌐 Python | 📅 2023-07-04 - Driver for TM1637 quad 7-segment LED modules.
* [micropython-tm1638](https://github.com/mcauser/micropython-tm1638) ⭐ 38 | 🐛 4 | 🌐 Python | 📅 2023-06-15 - Driver for TM1638 dual quad 7-segment LED modules with switches.
...
* [Official SSD1306](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/ssd1306) ⭐ 2,783 | 🐛 293 | 🌐 Python | 📅 2026-04-15 - Driver for SSD1306 128x64 OLED displays.
* [SH1106](https://github.com/robert-hh/SH1106) ⭐ 242 | 🐛 2 | 🌐 Python | 📅 2025-05-22 - Driver for the SH1106 OLED display.
* [micropython-ssd1351](https://github.com/rdagger/micropython-ssd1351) ⭐ 62 | 🐛 0 | 🌐 Python | 📅 2025-03-15 - Driver for SSD1351 OLED displays.
* [micropython-ssd1309](https://github.com/rdagger/micropython-ssd1309) ⭐ 52 | 🐛 3 | 🌐 Python | 📅 2026-02-21 - MicroPython SSD1309 Monochrome OLED Display Driver.
* [SH1107](https://github.com/peter-l5/SH1107) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2025-05-28 - Driver for SH1107 OLED displays (128x128 and 128x64 pixels).
...
* [micropython-ssd1322](https://github.com/rdagger/micropython-ssd1322) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2024-09-29 - MicroPython display driver for SSD1322 grayscale OLED.
...
* [micropython-mcp23017](https://github.com/mcauser/micropython-mcp23017) ⭐ 89 | 🐛 5 | 🌐 Python | 📅 2024-02-05 - MicroPython driver for MCP23017 16-bit I/O Expander.
...
* [tca9548a](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/tca9548a.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MicroPython driver for the TCA9548A I2C multiplexer.
...
* [asynchronous encoder driver](https://github.com/peterhinch/micropython-async/blob/master/v3/primitives/encoder.py) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - Interface an encoder to uasyncio code.
* [encoders](https://github.com/peterhinch/micropython-samples/blob/master/encoders/ENCODERS.md) ⭐ 526 | 🐛 13 | 🌐 Python | 📅 2025-09-14 - Short document explaining issues around encoder technology.
* [micropython-rotary](https://github.com/miketeachman/micropython-rotary) ⭐ 337 | 🐛 17 | 🌐 Python | 📅 2024-04-30 - MicroPython module to read a rotary encoder.
...
* [Sun and Moon](https://github.com/peterhinch/micropython-samples/blob/master/astronomy/README.md) ⭐ 526 | 🐛 13 | 🌐 Python | 📅 2025-09-14 - Determine Sun and Moon rise and set times, Moon phases.
* [micropython-ulab](https://github.com/v923z/micropython-ulab) ⭐ 496 | 🐛 48 | 🌐 C | 📅 2026-04-08 - A NumPy-like fast vector module for MicroPython.
* [micropython-fourier](https://github.com/peterhinch/micropython-fourier) ⭐ 93 | 🐛 0 | 🌐 Python | 📅 2025-10-31 - Fast Fourier transform in MicroPython's inline ARM assembler.
...
* [micropython-npyfile](https://github.com/jonnor/micropython-npyfile/) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2025-11-30 - Numpy .npy file support for MicroPython, supports read/write/streaming.
...
* [micropython-servo](https://github.com/redoxcode/micropython-servo) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2025-11-16 - Library to control RC servos using direct PWM output in a tidy way.
...
* [micropython-rp2-smartStepper](https://github.com/bikeNomad/micropython-rp2-smartStepper) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-03-27 - RP2040/RP2350 library using PIO and DMA to control a stepper motor.
...
* [ADXL345\_spi\_micropython](https://github.com/AlekseyFedorovich/ADXL345_spi_micropython) ⭐ 21 | 🐛 3 | 🌐 Python | 📅 2024-08-19 - Library for interacting through the SPI protocol with an 'Analog Devices ADXL345' accelerometer from an MCU flashed with MicroPython.
...
* [BME280](https://github.com/robert-hh/BME280) ⭐ 134 | 🐛 2 | 🌐 Python | 📅 2025-06-15 - MicroPython driver for the BME280 sensor, target platform Pycom devices.
* [micropython-bmp280](https://github.com/dafvid/micropython-bmp280) ⭐ 116 | 🐛 4 | 🌐 Python | 📅 2023-11-18 - Module for the BMP280 sensor.
...
* [MicroPython-BMPxxx](https://github.com/bradcar/MicroPython_BMPxxx) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2025-10-23 - Driver for BMP585, BMP581, BMP390, BMP280 Bosch temperature/pressure sensors.
...
* [BMP390](https://github.com/octaprog7/BMP390) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-03-27 - MicroPython module for BMP390 pressure & temperature sensor.
* [BMP180](https://github.com/octaprog7/BMP180) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-03-27 - MicroPython module for BMP180 pressure & temperature sensor.
...
* [max30102](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/max30102.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MicroPython driver for the MAX30102, with heartbeat detection and BPM measurement.

#### Camera

* [micropython-camera-driver](https://github.com/lemariva/micropython-camera-driver) ⭐ 559 | 🐛 34 | 🌐 C | 📅 2023-10-22 - OV2640 camera driver for MicroPython on ESP32.
* [uPyCam](https://github.com/lemariva/uPyCam) ⭐ 166 | 🐛 11 | 🌐 Python | 📅 2022-02-02 - Take a photo with an ESP32-CAM running MicroPython.
* [micropython-camera-API](https://github.com/cnadler86/micropython-camera-API) ⭐ 146 | 🐛 1 | 🌐 C | 📅 2026-01-12 - Project with the aim of supporting cameras across various ports in MicroPython, starting with the ESP32 port and Omnivision cameras (OV2640 & OV5640).
* [micropython-ov2640](https://github.com/namato/micropython-ov2640) ⭐ 122 | 🐛 8 | 🌐 Python | 📅 2022-10-05 - MicroPython class for OV2640 camera.
* [esp32-cam-micropython](https://github.com/shariltumin/esp32-cam-micropython) ⭐ 95 | 🐛 11 | 🌐 Makefile | 📅 2022-06-13 - MicroPython ESP32-CAM.
* [IoTy huskylib](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/huskylib.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MicroPython driver for the DFRobot Husky Lens. An easy-to-use AI Camera / Vision Sensor, featuring face recognition, object tracking, object recognition, line tracking, color recognition, and QR code recognition.
* [IoTy mv](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/mv.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - A simple machine vision library that provides blob and circle detection.
...
* [TI\_INA226\_micropython](https://github.com/elschopi/TI_INA226_micropython) ⭐ 40 | 🐛 1 | 🌐 Python | 📅 2026-02-21 - MicroPython driver for Texas Instruments INA226 power measuring IC.
...
* [VL53L0X](https://github.com/uceeatz/VL53L0X) ⭐ 49 | 🐛 9 | 🌐 Python | 📅 2022-04-24 - MicroPython Library for LiDAR Sensor VL53L0X.
...
* [vl53l5cx](https://github.com/mp-extras/vl53l5cx) ⭐ 24 | 🐛 8 | 🌐 Python | 📅 2024-05-10 - MicroPython and CircuitPython Package for the [VL53L5CX](https://www.st.com/en/imaging-and-photonics-solutions/vl53l5cx.html) (4x4/8x8 ToF sensor array).
* [vl53l1x](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/vl53l1x.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MicroPython driver for the VL53L1X ToF sensor.
* [IoTy lds02rr](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/lds02rr.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - Driver for the LDS02RR 360 degree LiDAR.
* [IoTy coind4](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/coind4.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - Driver for the COIN-D4 360 degree LiDAR.
* [IoTy delta2d](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/delta2d.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - Driver for the Delta-2D 360 degree LiDAR.
...
* [micropython-hcsr04](https://github.com/rsc1975/micropython-hcsr04) ⭐ 168 | 🐛 2 | 🌐 Python | 📅 2023-03-08 - Driver for HC-SR04 ultrasonic distance sensors.
...
* [micropython-p1meter](https://github.com/Josverl/micropython-p1meter) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2025-09-21 - A ESP32 sensor to read a p1 electricity meter and publish this to MQTT and Home Assistant, written in MicroPython.
...
* [SCD4x](https://github.com/octaprog7/SCD4x) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-04-12 - MicroPython module for work with SCD4x (SCD40, SCD41) low power CO2, temperature & humidity electroacoustic sensor from Sensirion.
...
* [ld2410](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/ld2410.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - 24GHz human presence sensing module, capable of detecting moving and stationary targets, and providing an approximate range.
...
* [veml7700](https://github.com/octaprog7/veml7700) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-04-15 - MicroPython module for the VEML7700 ambient light sensor (ALS) from Vishay.
...
* [hx710](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/hx710.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MicroPython driver for the HX710.
...
* [RM3100](https://github.com/octaprog7/RM3100) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2023-10-12 - MicroPython module for RM3100 geomagnetic sensor.
...
* [micropython-fusion](https://github.com/micropython-IMU/micropython-fusion) ⭐ 346 | 🐛 5 | 🌐 Python | 📅 2020-08-26 - Sensor fusion calculates heading, pitch and roll from the outputs of motion tracking devices.
...
* [micropython-bno055](https://github.com/micropython-IMU/micropython-bno055) ⭐ 61 | 🐛 3 | 🌐 Python | 📅 2025-10-11 - Bosch BNO055 driver for MicroPython. IMU with hardware sensor fusion.
...
* [apds9960](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/apds9960.py) ⭐ 16 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-15 - MicroPython Driver for the APDS9960, with simple gesture detection.
...
* [Official DHT11+DHT12](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/sensor/dht) ⭐ 2,783 | 🐛 293 | 🌐 Python | 📅 2026-04-15 - ESP8266 driver for DHT11 and DHT12 temperature and humidity sensor.
* [HTU21D](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/HTU21D.md) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - Asynchronous driver for HTU21D temperature and humidity sensor.
...
* [micropython\_ahtx0](https://github.com/targetblank/micropython_ahtx0) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2023-10-12 - MicroPython driver for the AHT10 and AHT20 temperature and humidity sensors.
...
* [bme680-pure-mp](https://github.com/antirez/bme680-pure-mp) ⭐ 18 | 🐛 3 | 🌐 Python | 📅 2026-03-28 - Pure MicroPython Bosch BME680 sensor driver.
...
* [Schedule](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/SCHEDULE.md) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - A scheduler for asyncio based applications. Schedule events at specified times and dates or with reference to Sun and Moon rise and set.
...
* [micropython-aioschedule](https://github.com/ThinkTransit/micropython-aioschedule) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2024-09-17 - A persistent uasyncio scheduler that supports deepsleep between task runs.
...
* [uSQLite](https://github.com/spatialdude/usqlite) ⭐ 127 | 🐛 15 | 🌐 C | 📅 2024-11-01 - SQLite library module for MicroPython.
* [micropg](https://github.com/nakagami/micropg) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-04-16 - PostgreSQL database driver for MicroPython.
...
* [micropython-cratedb](https://github.com/crate/micropython-cratedb/) ⭐ 10 | 🐛 5 | 🌐 Python | 📅 2026-04-02 - MicroPython driver for CrateDB databases.
...
* [micropython-winbond](https://github.com/brainelectronics/micropython-winbond) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2024-05-30 - Interact with Winbond W25Q Flash chips via SPI.
...
* [MicroWorkers](https://github.com/jczic/MicroWorkers) ⭐ 50 | 🐛 1 | 🌐 Python | 📅 2019-09-19 - A micro workers class that easily manages a pool of threads to optimise simultaneous jobs and jobs endings, for MicroPython (used on Pycom modules & ESP32).
...
* [mp\_wcwidth](https://github.com/Josverl/mp_wcwidth) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-01-27 - Python port of [wcwidth](https://github.com/jquast/wcwidth) ⭐ 452 | 🐛 4 | 🌐 Python | 📅 2026-04-15 to handle wide unicode characters such as "你好世界" in terminal output.
...
* [asyncio](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/TUTORIAL.md) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - Write asynchronous code which interfaces to hardware devices.
* [Asynchronous drivers](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/DRIVERS.md) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-03-16 - Tutorial and code for asynchronous interfaces to switches, pushbuttons, encoders and ADCs.
* [3D rotation with quaternions](https://github.com/peterhinch/micropython-samples/blob/master/QUATERNIONS.md) ⭐ 526 | 🐛 13 | 🌐 Python | 📅 2025-09-14 - Tutorial and code for the easy way to do 3D rotation.
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 367 | 🐛 0 | 🌐 Python | 📅 2026-04-15 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* [micrOS](https://github.com/BxNxM/micrOS) ⭐ 134 | 🐛 0 | 🌐 Python | 📅 2026-04-15 - MicroPython-based IoT Framework.
...
* [public-micropython-iot-platform](https://github.com/wolfen351/public-micropython-iot-platform) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2025-07-21 - Project Fred MicroPython IOT Platform, code to control relays, temp sensors, buttons, touchscreen, GPS etc. Has a responsive Web UI, MQTT, Home Assistant and ThingsBoard support.
* [perthensis](https://codeberg.org/scy/perthensis) - Perthensis: an asynchronous framework for MicroPython.

## Resources

* [MicroPython on GitHub](https://github.com/micropython/micropython) ⭐ 21,625 | 🐛 1,869 | 🌐 C | 📅 2026-04-15 - Submit bug reports, follow and join in development on GitHub.
* [MicroPython Wiki](https://github.com/micropython/micropython/wiki) ⭐ 21,625 | 🐛 1,869 | 🌐 C | 📅 2026-04-15 - Community generated documentation and examples of the features of MicroPython and the Pyboard.
...
* [micropy-cli](https://github.com/BradenM/micropy-cli) ⭐ 335 | 🐛 52 | 🌐 Python | 📅 2026-04-14 - Micropy CLI is a project management/generation tool for writing MicroPython code in modern IDEs such as Visual Studio Code.
* [micropython-stubs](https://github.com/Josverl/micropython-stubs) ⭐ 296 | 🐛 28 | 🌐 Python | 📅 2026-04-16 - Stubs of most MicroPython ports, boards and versions to make writing code that much simpler.
* [micropython-stubber](https://github.com/Josverl/micropython-stubber) ⭐ 248 | 🐛 18 | 🌐 Python | 📅 2026-04-13 - Generate and use stubs for different MicroPython firmwares to use with Visual Studio Code or any IDE and linter.
...
* [micropython-package-template](https://github.com/brainelectronics/micropython-package-template) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-04-14 - GitHub workflow supported MicroPython package template with deploys to the [Python Package Index](https://pypi.org/) on a push to the main branch and test deploys to the [Test Python Package Index](https://test.pypi.org/) on PRs.
...
* [ESP32-MPY-Jama](https://github.com/jczic/ESP32-MPY-Jama) ⭐ 485 | 🐛 33 | 🌐 Python | 📅 2023-05-03 - Tool for managing Espressif ESP32 microcontrollers with MicroPython.
* [pye](https://github.com/robert-hh/Micropython-Editor) ⭐ 252 | 🐛 3 | 🌐 Python | 📅 2026-01-22 - On device editor.
...
* [micropython-ulogger](https://github.com/majoson-chen/micropython-ulogger) ⭐ 39 | 🐛 6 | 🌐 Python | 📅 2022-06-16 - Lightweight log module customized for MicroPython.
...
* [micropython-magic](https://github.com/josverl/micropython-magic) ⭐ 31 | 🐛 9 | 🌐 Python | 📅 2026-02-24 - MicroPython integrated into Jupyter notebooks.
...
* [Micropython-Editor](https://github.com/robert-hh/Micropython-Editor) ⭐ 252 | 🐛 3 | 🌐 Python | 📅 2026-01-22 - Small on-board editor for Pyboard, WiPy, ESP8266, ESP32, PyCom and Adafruit devices written in Python.
...
* [mpremote](https://github.com/micropython/micropython/blob/master/tools/mpremote/README.md) ⭐ 21,625 | 🐛 1,869 | 🌐 C | 📅 2026-04-15 - Powerful official shell that supports mounting the host's current directory on the target. Run code without changing the target's filesystem.
* [rshell](https://github.com/dhylands/rshell) ⭐ 1,035 | 🐛 132 | 🌐 Python | 📅 2024-12-04 - Copy or sync files to boards, enter REPL from your terminal.
* [ampy](https://github.com/scientifichackers/ampy) ⭐ 757 | 🐛 41 | 🌐 Python | 📅 2024-07-16 - Utility to interact with a MicroPython board over a serial connection.
* [mpfshell](https://github.com/wendlers/mpfshell) ⭐ 415 | 🐛 27 | 🌐 Python | 📅 2025-01-09 - A simple shell-based file explorer for ESP8266 and WiPy.
...
* [mpr](https://github.com/bulletmark/mpr) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-02-16 - Wrapper for MicroPython mpremote tool.
...
* [belay](https://github.com/BrianPugh/belay) ⭐ 268 | 🐛 2 | 🌐 Python | 📅 2026-03-03 - Belay is a Python library that enables the rapid development of projects that interact with hardware via a MicroPython-compatible board.
...
Contributions and suggestions are always welcome! Please take a look at the [contribution guidelines](https://github.com/mcauser/awesome-micropython/blob/master/contributing.md) ⭐ 1,759 | 🐛 6 | 🌐 HTML | 📅 2026-03-19 first.
