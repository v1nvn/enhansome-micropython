...
* [tamp](https://github.com/BrianPugh/tamp) ⭐ 61 | 🐛 3 | 🌐 C | 📅 2026-02-06 - A low-memory, MicroPython-optimized, DEFLATE-inspired lossless compression library.
...
* [aiomqttc](https://github.com/Tangerino/aiomqttc.git) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2025-05-21 - Asynchronous MQTT Client for Micropython AND CPython.
...
* [micropython\_ir](https://github.com/peterhinch/micropython_ir) ⭐ 297 | 🐛 11 | 🌐 Python | 📅 2025-08-13 - Nonblocking device drivers to receive from IR remotes and for IR "blaster" apps.
...
* [micropySX126X](https://github.com/ehong-tl/micropySX126X) ⭐ 156 | 🐛 14 | 🌐 Python | 📅 2025-12-07 - Semtech SX126X LoRa driver for MicroPython and CircuitPython.
...
* [micropython-mqtt](https://github.com/peterhinch/micropython-mqtt) ⭐ 676 | 🐛 21 | 🌐 Python | 📅 2026-01-29 - A 'resilient' asynchronous MQTT client: recovers from WiFi and broker outages.
* [MQBoard](https://github.com/tve/mqboard) ⭐ 129 | 🐛 20 | 🌐 Python | 📅 2022-05-08 - A micro-framework for using MQTT with asyncio on MicroPython boards, primarily on the ESP32.
...
* [Official OneWire](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/bus/onewire) ⭐ 2,745 | 🐛 279 | 🌐 Python | 📅 2025-12-09 - For devices using the OneWire bus, eg Dallas DS18x20.
...
* [senko](https://github.com/RangerDigital/senko) ⭐ 100 | 🐛 5 | 🌐 Python | 📅 2024-02-23 - Simplest OTA update solution for your MicroPython projects.
...
* [Official nRF24L01](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/radio/nrf24l01) ⭐ 2,745 | 🐛 279 | 🌐 Python | 📅 2025-12-09 - Official driver for nRF24L01 2.4GHz radio modules.
...
* [EByte\_LoRa\_E22\_micropython\_library](https://github.com/xreef/EByte_LoRa_E22_micropython_library) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2025-02-23 - MicroPython LoRa EBYTE E22 devices.
...
* [urdm6300](https://github.com/membermatters/urdm6300) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2024-12-19 - A MicroPython driver for the popular RDM6300 RFID card reader.
...
* [micropython-uprotobuf](https://github.com/jazzycamel/micropython-uprotobuf) ⭐ 23 | 🐛 2 | 🌐 Python | 📅 2023-02-10 - A lightweight implementation of Google's Protocol Buffers (protobuf) for MicroPython.
...
* [microdot](https://github.com/miguelgrinberg/microdot) ⭐ 2,069 | 🐛 5 | 🌐 Python | 📅 2026-02-04 - The impossibly small web framework for MicroPython.
* [MicroWebSrv2](https://github.com/jczic/MicroWebSrv2) ⭐ 711 | 🐛 55 | 🌐 Python | 📅 2025-08-18 - The last micro web server for IoTs (MicroPython) or large servers (CPython), that supports WebSocket, routes, template engine and with really optimized architecture (mem allocations, async I/Os).
...
* [MicroRESTCli](https://github.com/jczic/MicroRESTCli) ⭐ 29 | 🐛 2 | 🌐 Python | 📅 2020-12-12 - A micro JSON REST web client based on MicroWebCli for MicroPython (used on Pycom modules & ESP32).
...
* [micropython-waveshare-epaper](https://github.com/mcauser/micropython-waveshare-epaper) ⭐ 381 | 🐛 21 | 🌐 Python | 📅 2021-09-01 - Drivers for various Waveshare ePaper modules.
...
* [Inkplate-micropython](https://github.com/SolderedElectronics/Inkplate-micropython) ⭐ 89 | 🐛 5 | 🌐 Python | 📅 2025-09-26 - MicroPython driver for Inkplate boards.
...
* [micropython-font-to-py](https://github.com/peterhinch/micropython-font-to-py) ⭐ 451 | 🐛 8 | 🌐 Python | 📅 2025-05-28 - A Python 3 utility to convert fonts to Python source capable of being frozen as bytecode.
* [writer](https://github.com/peterhinch/micropython-font-to-py/blob/master/writer/WRITER.md) ⭐ 451 | 🐛 8 | 🌐 Python | 📅 2025-05-28 - A simple way to render above Python fonts to displays whose driver is subclassed from `framebuf`.
* [microfont](https://github.com/antirez/microfont) ⭐ 72 | 🐛 2 | 🌐 Python | 📅 2026-01-31 - Text drawing library for MicroPython framebuffer.
* [packed-font](https://github.com/mark-gladding/packed-font) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2023-06-05 -  Memory efficient MicroPython fonts for the Pico Pi and SSD1306 OLED Display.
...
* [lvgl](https://github.com/lvgl/lv_binding_micropython) ⭐ 335 | 🐛 64 | 🌐 C | 📅 2025-09-17 - An object-oriented, component-based high-level GUI library with MicroPython binding.
...
* [Official LCD160CR](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/lcd160cr) ⭐ 2,745 | 🐛 279 | 🌐 Python | 📅 2025-12-09 - Driver for official MicroPython LCD160CR display with resistive touch sensor.
...
* [MicroPython-ST7735](https://github.com/boochow/MicroPython-ST7735) ⭐ 266 | 🐛 9 | 🌐 Python | 📅 2022-12-30 - ESP32 version of GuyCarvers's ST7735 TFT LCD driver.
...
* [st7789\_mpy](https://github.com/russhughes/st7789_mpy) ⭐ 688 | 🐛 36 | 🌐 Python | 📅 2024-08-16 - Fast MicroPython driver for ST7789 display module written in C.
* [micropython-ili9341](https://github.com/rdagger/micropython-ili9341) ⭐ 287 | 🐛 3 | 🌐 Python | 📅 2025-03-02 - MicroPython ILI9341 display & XPT2046 touch screen driver.
* [st7789py\_mpy](https://github.com/russhughes/st7789py_mpy) ⭐ 232 | 🐛 16 | 🌐 Python | 📅 2024-08-05 - Driver for 320x240, 240x240 and 135x240 ST7789 displays written in MicroPython.
...
* [s3lcd](https://github.com/russhughes/s3lcd) ⭐ 105 | 🐛 10 | 🌐 Python | 📅 2024-03-20 - ESP\_LCD based MicroPython driver for ESP32-S3 Devices with ST7789 or compatible displays.
...
* [Official SSD1306](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/ssd1306) ⭐ 2,745 | 🐛 279 | 🌐 Python | 📅 2025-12-09 - Driver for SSD1306 128x64 OLED displays.
* [SH1106](https://github.com/robert-hh/SH1106) ⭐ 233 | 🐛 2 | 🌐 Python | 📅 2025-05-22 - Driver for the SH1106 OLED display.
...
* [MicroPython-ADC\_Cal](https://github.com/matthias-bs/MicroPython-ADC_Cal) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2025-09-16 - ESP32 ADC driver using reference voltage calibration value from efuse.
...
* [micropython-rotary](https://github.com/miketeachman/micropython-rotary) ⭐ 332 | 🐛 17 | 🌐 Python | 📅 2024-04-30 - MicroPython module to read a rotary encoder.
...
* [micropython-ulab](https://github.com/v923z/micropython-ulab) ⭐ 492 | 🐛 49 | 🌐 C | 📅 2025-10-08 - A NumPy-like fast vector module for MicroPython.
...
* [umatrix](https://github.com/iyassou/umatrix) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2022-02-14 - A matrix library for the MicroPython language.
...
* [MAX30102-MicroPython-driver](https://github.com/n-elia/MAX30102-MicroPython-driver) ⭐ 82 | 🐛 0 | 🌐 Python | 📅 2024-04-10 - A MAX30102 driver ported to MicroPython. It should also work for MAX30105.
...
* [micropython-camera-driver](https://github.com/lemariva/micropython-camera-driver) ⭐ 549 | 🐛 34 | 🌐 C | 📅 2023-10-22 - OV2640 camera driver for MicroPython on ESP32.
* [uPyCam](https://github.com/lemariva/uPyCam) ⭐ 164 | 🐛 11 | 🌐 Python | 📅 2022-02-02 - Take a photo with an ESP32-CAM running MicroPython.
* [micropython-camera-API](https://github.com/cnadler86/micropython-camera-API) ⭐ 136 | 🐛 1 | 🌐 C | 📅 2026-01-12 - Project with the aim of supporting cameras across various ports in MicroPython, starting with the ESP32 port and Omnivision cameras (OV2640 & OV5640).
...
* [esp32-cam-micropython](https://github.com/shariltumin/esp32-cam-micropython) ⭐ 94 | 🐛 11 | 🌐 Makefile | 📅 2022-06-13 - MicroPython ESP32-CAM.
* [huskylib](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/huskylib.py) ⭐ 15 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-03 - MicroPython driver for the DFRobot Husky Lens. An easy-to-use AI Camera / Vision Sensor, featuring face recognition, object tracking, object recognition, line tracking, color recognition, and QR code recognition.
...
* [hx711](https://github.com/robert-hh/hx711) ⭐ 65 | 🐛 2 | 🌐 Python | 📅 2025-09-09 - MicroPython driver for the HX711 load cell interface.
...
* [micropython-bno055](https://github.com/micropython-IMU/micropython-bno055) ⭐ 60 | 🐛 2 | 🌐 Python | 📅 2025-10-11 - Bosch BNO055 driver for MicroPython. IMU with hardware sensor fusion.
...
* [Official DHT11+DHT12](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/sensor/dht) ⭐ 2,745 | 🐛 279 | 🌐 Python | 📅 2025-12-09 - ESP8266 driver for DHT11 and DHT12 temperature and humidity sensor.
...
* [micropython-sht31](https://github.com/kfricke/micropython-sht31) ⭐ 25 | 🐛 1 | 🌐 Python | 📅 2023-07-16 - Driver for the SHT31 temperature and humidity sensor.
...
* [micropython-mlx90614](https://github.com/mcauser/micropython-mlx90614) ⭐ 37 | 🐛 6 | 🌐 Python | 📅 2024-04-16 - Driver for Melexis MLX90614 IR temperature sensor.
...
* [uSQLite](https://github.com/spatialdude/usqlite) ⭐ 125 | 🐛 15 | 🌐 C | 📅 2024-11-01 - SQLite library module for MicroPython.
...
* [micropython-cratedb](https://github.com/crate/micropython-cratedb/) ⭐ 10 | 🐛 5 | 🌐 Python | 📅 2025-12-04 - MicroPython driver for CrateDB databases.
...
* [mp\_wcwidth](https://github.com/Josverl/mp_wcwidth) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-01-27 - Python port of [wcwidth](https://github.com/jquast/wcwidth) ⭐ 437 | 🐛 1 | 🌐 Python | 📅 2026-02-06 to handle wide unicode characters such as "你好世界" in terminal output.
...
* [micrOS](https://github.com/BxNxM/micrOS) ⭐ 127 | 🐛 0 | 🌐 Python | 📅 2026-01-31 - MicroPython-based IoT Framework.
...
* [MicroPython on GitHub](https://github.com/micropython/micropython) ⭐ 21,442 | 🐛 1,840 | 🌐 C | 📅 2026-02-07 - Submit bug reports, follow and join in development on GitHub.
* [MicroPython Wiki](https://github.com/micropython/micropython/wiki) ⭐ 21,442 | 🐛 1,840 | 🌐 C | 📅 2026-02-07 - Community generated documentation and examples of the features of MicroPython and the Pyboard.
...
* [micropy-cli](https://github.com/BradenM/micropy-cli) ⭐ 332 | 🐛 50 | 🌐 Python | 📅 2026-02-03 - Micropy CLI is a project management/generation tool for writing MicroPython code in modern IDEs such as Visual Studio Code.
* [micropython-stubs](https://github.com/Josverl/micropython-stubs) ⭐ 287 | 🐛 28 | 🌐 Python | 📅 2026-02-06 - Stubs of most MicroPython ports, boards and versions to make writing code that much simpler.
* [micropython-stubber](https://github.com/Josverl/micropython-stubber) ⭐ 244 | 🐛 23 | 🌐 Python | 📅 2026-01-08 - Generate and use stubs for different MicroPython firmwares to use with Visual Studio Code or any IDE and linter.
...
* [pye](https://github.com/robert-hh/Micropython-Editor) ⭐ 249 | 🐛 3 | 🌐 Python | 📅 2026-01-22 - On device editor.
...
* [Micropython-Editor](https://github.com/robert-hh/Micropython-Editor) ⭐ 249 | 🐛 3 | 🌐 Python | 📅 2026-01-22 - Small on-board editor for Pyboard, WiPy, ESP8266, ESP32, PyCom and Adafruit devices written in Python.
* [upy-shell](https://github.com/dhylands/upy-shell) ⭐ 42 | 🐛 9 | 🌐 Python | 📅 2018-03-23 - A simple command line-based shell for MicroPython.

#### On Host

* [mpremote](https://github.com/micropython/micropython/blob/master/tools/mpremote/README.md) ⭐ 21,442 | 🐛 1,840 | 🌐 C | 📅 2026-02-07 - Powerful official shell that supports mounting the host's current directory on the target. Run code without changing the target's filesystem.
...
Contributions and suggestions are always welcome! Please take a look at the [contribution guidelines](https://github.com/mcauser/awesome-micropython/blob/master/contributing.md) ⭐ 1,742 | 🐛 25 | 🌐 HTML | 📅 2026-01-25 first.
